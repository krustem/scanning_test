...
def sorting_keypoints_by_Y(key_points):
    x_y_of_keypoints = []
...
def main():
    ...
    original_image = cv2.imread('images/not_empty/Scan_0010.jpg')
    ...
    print("Marked Sector 8: ", characters_s8)
    print("Marked Sector 9: ", characters_s9)
    print("Marked Sector 10: ",characters_s10)
    print("Marked Sector 11 part 1: ",characters_s11_p1)
    print("Marked Sector 11 part 2: ",characters_s11_p2)
    print("Marked Sector 12 part 1: ",characters_s12_p1)
    print("Marked Sector 12 part 2: ",characters_s12_p2)

    print("Бейіндік пән 1:")
    print(characters_s11_bp_s1)
    print(characters_s11_bp_s2)
    print(characters_s11_bp_s3)

    print("Бейіндік пән 2:")
